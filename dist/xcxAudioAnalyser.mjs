...
var en = {
	...
	"xcxAudioAnalyser.getPitch": "pitch (Hz)"
};
var ja = {
	"xcxAudioAnalyser.name": "Audio Analyser",
	...
	"xcxAudioAnalyser.getPitch": "音程 (Hz)"
};
var translations = {
	en: en,
	ja: ja,
	...
	"xcxAudioAnalyser.getPitch": "おんてい (Hz)"
}
};
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  return _createClass$1(ExtensionBlocks, [{
    ...
    key: "getPitch",
    value: (function () {
      var _getPitch = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
        var context, analyser, fftSize, byteData, i, pitch, _t2;
